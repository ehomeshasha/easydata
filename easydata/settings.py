...
GV = {
    'site': {
        'keywords': 'keywords_foo',
        'description': 'description_foo',
        'generator': 'generator_foo',
        'author': 'author_foo',
        'copyright': 'copyright_foo',
        'baseurl': 'baseurl_foo',
        'title': 'title_foo',
        'sitename': 'sitename_foo',
    },
    'path': {
        'header': "bigdata/common/header.html",
        'footer': "bigdata/common/footer.html",
        'leftside': "bigdata/common/leftside.html",
        'rightside': "bigdata/common/rightside.html",
        'css': 'bigdata/css/',
