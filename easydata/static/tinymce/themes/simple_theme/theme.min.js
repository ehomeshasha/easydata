...
tinymce.ThemeManager.add('simple_theme', function(editor) {
	...
	settings.toolbar = " emoticons | fontsizeselect | bold italic underline forecolor backcolor highlight_text | link image fileupload | alignleft aligncenter alignright | undo redo ";
