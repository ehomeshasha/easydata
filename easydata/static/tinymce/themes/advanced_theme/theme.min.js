...
tinymce.ThemeManager.add('advanced_theme', function(editor) {
	...
	settings.tools = "inserttable";
	settings.toolbar = " emoticons | styleselect fontsizeselect | bold italic underline forecolor backcolor highlight_text |anchor anchor link insertcode image fileupload table code | alignleft aligncenter alignright | undo redo "
